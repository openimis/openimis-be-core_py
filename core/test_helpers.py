...
def create_test_interactive_user(username='TestAdminTest', password="Test1234", roles=None, custom_props=None):
    if roles is None:
        roles = [7, 1, 2, 3, 4, 5, 6]
...
def create_test_technical_user(
        username='TestAdminTest', password="S\/pe®Pąßw0rd""", super_user=False,
